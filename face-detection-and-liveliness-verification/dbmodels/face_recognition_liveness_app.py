...
def video_feed(request):
    ...
    def recognition_liveness():
        args = {'model':'dbmodels/liveness3.model' , 'le':'dbmodels/label_encoder3.pickle' , 'detector':'dbmodels/face_detector',
                'encodings':'../face_recognition/en2.pickle', 'confidence':0.5}

        # load the encoded faces and names
        print('[INFO] loading encodings...')
        with open('dbmodels/en2.pickle', 'rb') as file:
